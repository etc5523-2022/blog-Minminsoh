...
@fig-statecomparison2 categorise the states into three categories, namely states which are above the national average, states which are below the national average or states which are around the national average. @fig-statecomparison then shows the disparity of the percentage of adults reaching the national target level in each state, ranges from the most active state to the least active state. 
